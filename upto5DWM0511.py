...
File Name       :   upto5DWM0511.py

Function        :   1. garbage input detection
                    2. camera shooting
                    3. recognition of trash documents
                    4. Upload to 5D World Map Folder (=Google Drive)
...
def main():
    ...
    measure() # read_distance() -> capture_photo() -> inference()g -> upload_image()
...
def upload_image():
    ...
    global FOLDER_ID
    global image_recognition_progress
